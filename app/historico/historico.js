/* v22 = mesmo JS estável do v20 (NENHUMA mudança funcional) */
(function(){
  "use strict";
  ...
  btnLimparDia?.addEventListener('click', ()=>{
    const b=btnLimparDia;
    b.classList.add('pulse'); b.addEventListener('animationend',()=>b.classList.remove('pulse'),{once:true});
